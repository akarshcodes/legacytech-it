        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              ...
              <span className="text-sm font-semibold text-gray-600">IT</span>
            </motion.div>
          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-4 border-t space-y-3">
                <a href="tel:+6041234567" className="flex items-center space-x-3 text-gray-600">
                  <Phone className="h-5 w-5" />
                  <span>+604-123 4567</span>
                </a>
                <a href="mailto:info@legacyshield.my" className="flex items-center space-x-3 text-gray-600">
